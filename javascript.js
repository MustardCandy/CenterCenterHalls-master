...
var monsters = {
  1:{image:"A", name:"Aidan", health:1, damage:{min:1, max:2}, behavior:"blindAI"},
  2:{image:"D", name:"Dakota", health:6, damage:{min:4, max:9}, behavior:"simpleAI"},
  3:{image:"J", name:"Jake", health:7, damage:{min:5, max:10}, behavior:"blindAI"},
  4:{image:"K", name:"Kade", health:3, damage:{min:2, max:7}, behavior:"blindAI"},
